...
path_cdo_opt=/opt/render/project/src/child-processes/cdo


# cp $home/gdal-3.4.0.tar.gz $path_cdo_opt/
# cd $path_cdo_opt
# tar -xzf gdal-3.4.0.tar.gz
# cd gdal-3.4.0
# ./configure --prefix=$path_cdo_opt
# make
# make install
 

# cp $home/zlib-1.2.12.tar.gz $path_cdo_opt/
# cd $path_cdo_opt
# tar -xzf zlib-1.2.12.tar.gz
# cd zlib-1.2.12
# ./configure --prefix=$path_cdo_opt/cdo_exe  --static
# make
# make install
