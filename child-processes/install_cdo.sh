...
# cd $home/cdo-1.9.1
# ./configure -prefix=$home/cdo_installed CFLAGS=-fPIC -with-netcdf=$home/cdo_installed -with-jasper=$home/cdo_installed -with-hdf5=$home/cdo_installed -with-grib_api=$home/cdo_installed/grib_api-1.24.0-Source
# make && make check && make install
