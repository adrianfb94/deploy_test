...
#define CXX_VERSION "g++ (Debian 8.3.0-6) 8.3.0"

/* C Compiler */
#define C_COMPILER "gcc -g -O2 -fopenmp "

/* C Compiler version */
#define C_VERSION "gcc (Debian 8.3.0-6) 8.3.0"
...
/* Host name */
#define HOST_NAME "srv-cogj364f7o1s73808kig-hibernate-5b69965dcb-jmvxz"
